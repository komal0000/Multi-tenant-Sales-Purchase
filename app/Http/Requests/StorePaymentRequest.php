...
class StorePaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'sale_id' => ['nullable', 'integer', Rule::exists('sales', 'id')->where(fn ($query) => $query->where('tenant_id', $tenantId))],
            'purchase_id' => ['nullable', 'integer', Rule::exists('purchases', 'id')->where(fn ($query) => $query->where('tenant_id', $tenantId))],
        ];
    }
