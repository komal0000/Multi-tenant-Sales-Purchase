    ...
    <div class="space-y-6">
        ...
        <form method="GET" action="{{ route('accounts.index') }}" class="grid gap-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
            <div>
                ...
                <input type="text" name="keyword" value="{{ $filters['keyword'] ?? '' }}" placeholder="Account name or type" class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-1.5 text-sm">
            </div>
