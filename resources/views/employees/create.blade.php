    ...
    <div class="mx-auto max-w-2xl rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <form method="POST" action="{{ route('employees.store') }}" class="mt-6 space-y-4">
            ...
            <div>
                ...
                <select id="employee-party-select" name="party_id" class="select2 mt-1 w-full rounded-lg border border-gray-300 px-3 py-1.5 text-sm">
            ...
            <div>
                ...
                <input id="salary" name="salary" type="number" step="0.01" min="0" value="{{ old('salary', '0') }}" class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-1.5 text-sm">
            </div>
