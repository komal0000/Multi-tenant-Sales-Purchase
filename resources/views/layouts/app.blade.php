...
<body class="min-h-screen bg-gray-50 text-gray-800" x-data="{ sidebarOpen: false }">
    @php
        $navigationItems = [
            ...
            ['label' => 'Sales', 'route' => 'sales.create', 'active' => ['sales.create'], 'icon' => 'sales', 'section' => 'main'],
            ['label' => 'List Sales', 'route' => 'sales.index', 'active' => ['sales.index', 'sales.show'], 'icon' => 'sales', 'section' => 'main'],
