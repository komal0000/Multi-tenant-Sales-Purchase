            ...
            <form method="POST" action="{{ route('parties.opening-balance.update', $party) }}" class="mt-4 rounded-lg border border-gray-200 p-4">
                ...
                <div class="mt-3 grid gap-3 sm:grid-cols-2">
                    <div>
                        ...
                        <input id="opening_balance" name="opening_balance" type="number" min="0" step="0.01" value="{{ old('opening_balance', $party->opening_balance ?? 0) }}" class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-1.5 text-sm">
                    </div>
                    <div>
